...
func (x *IsAdminRueqest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IsAdminRueqest) ProtoMessage() {}

func (x *IsAdminRueqest) ProtoReflect() protoreflect.Message {
	mi := &file_sso_sso_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IsAdminRueqest.ProtoReflect.Descriptor instead.
func (*IsAdminRueqest) Descriptor() ([]byte, []int) {
	return file_sso_sso_proto_rawDescGZIP(), []int{4}
}

func (x *IsAdminRueqest) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x6d, 0x69, 0x61, 0x6c,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x6d, 0x69, 0x61, 0x6c, 0x12, 0x1a, 0x0a,
	...
	0x69, 0x6e, 0x52, 0x75, 0x65, 0x71, 0x65, 0x73, 0x74, 0x12, 0x17, 0x0a, 0x07, 0x75, 0x73, 0x65,
	...
	0x32, 0xab, 0x01, 0x0a, 0x04, 0x41, 0x75, 0x68, 0x74, 0x12, 0x39, 0x0a, 0x08, 0x52, 0x65, 0x67,
	...
	0x52, 0x75, 0x65, 0x71, 0x65, 0x73, 0x74, 0x1a, 0x15, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x49,
	0x73, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x15,
	0x5a, 0x13, 0x7a, 0x68, 0x61, 0x72, 0x69, 0x6b, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31, 0x3b,
...
var file_sso_sso_proto_goTypes = []any{
	...
	(*IsAdminRueqest)(nil),   // 4: auth.IsAdminRueqest
...
var file_sso_sso_proto_depIdxs = []int32{
	...
	4, // 2: auth.Auht.IsAdmin:input_type -> auth.IsAdminRueqest
	1, // 3: auth.Auht.Register:output_type -> auth.RegisterResponse
	3, // 4: auth.Auht.Login:output_type -> auth.LoginResponse
	5, // 5: auth.Auht.IsAdmin:output_type -> auth.IsAdminResponse
